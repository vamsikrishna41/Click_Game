  ...
  render() {
    return (
      <div><h1>Hit Thanos with mouse as many times as you can in this {this.state.time} Seconds </h1>
       <img className='thanos' src='https://i2.wp.com/www.artofvfx.com/wp-content/uploads/2018/05/Avengers3_WetaDigital_ITW_01A.jpg?fit=1400%2C737&ssl=1'  onClick={this.click} height={200}></img><br/>
